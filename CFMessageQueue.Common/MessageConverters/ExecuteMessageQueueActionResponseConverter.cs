...
{
    public class ExecuteMessageQueueActionResponseConverter : IExternalMessageConverter<ExecuteMessageQueueActionResponse>
    {
        public ConnectionMessage GetConnectionMessage(ExecuteMessageQueueActionResponse externalMessage)
        {
        ...
        public ExecuteMessageQueueActionResponse GetExternalMessage(ConnectionMessage connectionMessage)
        {
            var externalMessage = new ExecuteMessageQueueActionResponse()
            {
