...
{
    public class MessageQueueSubscribeResponseConverter : IExternalMessageConverter<MessageQueueSubscribeResponse>
    {
        public ConnectionMessage GetConnectionMessage(MessageQueueSubscribeResponse externalMessage)
        {
            var connectionMessage = new ConnectionMessage()
            {
                ...
                Parameters = new List<ConnectionMessageParameter>()
                {
                   ...
                   {
                       Name = "SubscribeId",
                       Value = externalMessage.SubscribeId                                        
                   }
                }
            };
        ...
        public MessageQueueSubscribeResponse GetExternalMessage(ConnectionMessage connectionMessage)
        {
            var externalMessage = new MessageQueueSubscribeResponse()
            {
                Id = connectionMessage.Id,
                SubscribeId = connectionMessage.Parameters.First(p => p.Name == "SubscribeId").Value
            };
