...
{
    public class AddMessageHubClientResponseConverter : IExternalMessageConverter<AddMessageHubClientResponse>
    {
        public ConnectionMessage GetConnectionMessage(AddMessageHubClientResponse externalMessage)
        {
        ...
        public AddMessageHubClientResponse GetExternalMessage(ConnectionMessage connectionMessage)
        {
            var externalMessage = new AddMessageHubClientResponse()
            {
