...
{
    internal class GetMessageHubsRequestProcessor : MessageProcessorBase, IMessageProcessor
    {
        public GetMessageHubsRequestProcessor(IAuditLog auditLog, ISimpleLog log, IServiceProvider serviceProvider) : base(auditLog, log, serviceProvider)
        {
        ...
        public Task ProcessAsync(MessageBase message, MessageReceivedInfo messageReceivedInfo)
        {
            ...
            {
                var getMessageHubsRequest = (GetMessageHubsRequest)message;
        ...
        {
            return message.TypeId == MessageTypeIds.GetMessageHubsRequest;
        }
    }
}
